...
/**
 * <p>
 * Generate class mutants according to selected class mutation operator(s) from
 * gui.GenMutantsMain. The original version is loaded, mutated, and compiled.
 * Outputs (mutated source and class files) are in the class-mutants folder.
 * </p>
 * 
 * <p>
 * Currently available class mutation operators: (1) AMC: Access modifier
 * change, (2) IHD: Hiding variable deletion, (3) IHI: Hiding variable
 * insertion, (4) IOD: Overriding method deletion, (5) IOP: Overriding method
 * calling position change, (6) IOR: Overriding method rename, (7) ISI: Super
 * keyword insertion, (8) ISD: Super keyword deletion, (9) IPC: Explicit call to
 * parent's constructor deletion, (10) PNC: New method call with child class
 * type, (11) PMD: Member variable declaration with parent class type, (12) PPD:
 * Parameter variable declaration with child class type, (13) PCI: Type cast
 * operator insertion, (14) PCC: Cast type change, (15) PCD: Type cast operator
 * deletion, (16) PRV: Reference assignment with other compatible variable, (17)
 * OMR: Overloading method contents replace, (18) OMD: Overloading method
 * deletion, (19) OAN: Arguments of overloading method call change, (20) JTI:
 * Java-specific this keyword insertion, (21) JTD: Java-specific this keyword
 * deletion, (22) JSI: Java-specific static modifier insertion, (23) JSD:
 * Java-specific static modifier deletion, (24) JID: Java-specific member
 * variable initialization deletion, (25) JDC: Java-supported default
 * constructor creation, (26) EOA: Java-specific reference assignment and
 * content assignment replacement, (27) EOC: Java-specific reference comparison
 * and content assignment replacement, (28) EAM: Java-specific accessor method
 * change, (29) EMM: Java-specific modifier method change
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class ClassMutantsGenerator extends MutantsGenerator {
	...
	String[] classOp;
	// Leo: Adicionei um List que vai acumular os operadores selecionados.
	...
	public ClassMutantsGenerator(File f, String[] cOP, List<String> allOperators) {
		super(f);
		classOp = cOP;
	...
	/**
	 * Verify if the target Java source and class files exist, generate class
	 * mutants
	 */
	void genMutants() {
		if (comp_unit == null) {
	...
	/**
	 * Apply selected class mutation operators: AMC, IOR, ISD, IOP, IPC, PNC,
	 * PMD, PPD, PRV, PCI, PCC, PCD, JSD, JSI, JTD, JTI, JID, OAN, EOA, EOC,
	 * EAM, EMM
	 * 
	 * @param cdecls
	 */
