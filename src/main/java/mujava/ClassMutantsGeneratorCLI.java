...
public class ClassMutantsGeneratorCLI  extends MutantsGenerator
{
   boolean existIHD = false;

   String[] classOp;

   public ClassMutantsGeneratorCLI (File f)
   {
      super(f);
      classOp = MutationSystem.cm_operators;
   }

   public ClassMutantsGeneratorCLI (File f, boolean debug)
   {
      super(f, debug);
      classOp = MutationSystem.cm_operators;
   }

   public ClassMutantsGeneratorCLI (File f, String[] cOP)
   {
      super(f);
      classOp = cOP;
   }
