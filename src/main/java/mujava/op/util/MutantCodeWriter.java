...
public class MutantCodeWriter extends ParseTreeVisitor {
	...
	public void saveContextInfo(ContextInfo context) {
	...
	public void writeContextInfo() {
		if (this.contextInfo != null) {
			...
			line_num++;
			out.println("MutationOperatorGroup=" + this.contextInfo.getMutationOperatorGroup());
			line_num++;
			out.println("Before=" + this.contextInfo.getBefore());
			line_num++;
			out.println("After=" + this.contextInfo.getAfter());
			line_num++;
			out.println("MutatedLine=" + mutated_line);
			line_num++;
			out.println("AstContext=" + this.contextInfo.getAstContext());
			line_num++;
			out.println(")*/");
			line_num++;
		}
	...
	public void visit(CompilationUnit p) throws ParseTreeException {
		...
		// Write context information into mutant file
		// writeContextInfo();
	...
	public void visit(InstanceofExpression p) throws ParseTreeException {
		...
		if (lexpr instanceof AssignmentExpression || lexpr instanceof ConditionalExpression
	...
	public void visit(UnaryExpression p) throws ParseTreeException {
		...
		if (expr instanceof AssignmentExpression || expr instanceof ConditionalExpression
				|| expr instanceof BinaryExpression || expr instanceof InstanceofExpression
				|| expr instanceof CastExpression || expr instanceof UnaryExpression) {
			writeParenthesis(expr);
		} else {
			expr.accept(this);
		}
	...
	protected void writeListWithDelimiterNewline(List list) throws ParseTreeException {
	...
	protected void writeListWithSuffixNewline(List list) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected void writeArguments(ExpressionList args) throws ParseTreeException {
		out.print("(");
		if (!args.isEmpty()) {
			out.print(" ");
			args.accept(this);
	...
	protected void writeListWithDelimiter(List list, String delimiter) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected void writeListWithDelimiterNewLine(List list, String delimiter) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected void writeListWithSuffix(List list, String suffix) throws ParseTreeException {
		Enumeration it = list.elements();
	...
	protected static final boolean isOperatorNeededLeftPar(int operator, Expression leftexpr) {
		if (leftexpr instanceof AssignmentExpression || leftexpr instanceof ConditionalExpression) {
			return true;
		}
	...
	protected static final boolean isOperatorNeededRightPar(int operator, Expression rightexpr) {
		if (rightexpr instanceof AssignmentExpression || rightexpr instanceof ConditionalExpression) {
			return true;
		}
