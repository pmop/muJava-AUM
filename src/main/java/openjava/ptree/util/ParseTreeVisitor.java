...
public abstract class ParseTreeVisitor {
	 ...
	 * @throws ParseTreeException
	 */
	public abstract void visit(EnumDeclaration p) throws ParseTreeException;
	public abstract void visit(EnumConstant p) throws ParseTreeException;
	 ...
	 * 
	 * Note: can't add this unless you want to modify muJava src,
	 * the abstract class makes muJava files have compile errors
	 * 
	 */
	public abstract void visit(AssertStatement p) throws ParseTreeException;
}
