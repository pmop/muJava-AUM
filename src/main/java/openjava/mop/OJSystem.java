 ...
 * @author   modified by Nan Li July 2012 for Java generics
 * @see java.lang.Object
 */
public class OJSystem {
	...
	/** newly added in July 2012 **/
	/** class members are added for generics type parameters **/
	/** revoked Obctober 2012 **/
	//public static OJClass T, U, E, K, N, V, S;
	...
	public static final void initConstants() {
		...
		// Type
		//T = OJClass.forClass(Object.class);
		// 3rd type
		//U = OJClass.forClass(Object.class);
		// Element
		//E = OJClass.forClass(Object.class);
		// Key
		//K = OJClass.forClass(Object.class);
		// Number
		//N = OJClass.forClass(Object.class);
		// Value or 4th type
		//V = OJClass.forClass(Object.class);
		// 2nd type
		//S = OJClass.forClass(Object.class);
		/*
		env.record("T", T);
		env.record("U", U);
		env.record("E", E);
