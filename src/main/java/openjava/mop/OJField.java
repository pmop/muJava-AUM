...
public class OJField implements OJMember, Cloneable
{
    ...
    public OJField( Environment env, OJClass declarer, EnumConstant ec ) {
    	this.substance = new OJFieldSourceCode( env, declarer, ec );
    }
    
    public OJField( Environment env, OJClass declarer, FieldAccess ec ) {
    	this.substance = new OJFieldSourceCode( env, declarer, ec );
    }
    ...
    public boolean isEnumConstant(){
    	return substance.isEnumConstant();
    }
...
abstract class OJFieldImp
{
     ...
     * @return
     */
    abstract boolean isEnumConstant();
    /* -- methods java.lang.reflect.Field does not supply. -- */
...
class OJFieldSourceCode extends OJFieldImp
{
    ...
    private EnumConstant		definitionEnum = null;
    private Environment			env;
    private FieldAccess			definitionStaticImportedField = null;
 ...
 {
    	this.declarer = declarer;
		this.definitionStaticImportedField = ptree;
		this.env = env;
		this.id = idCounter++;
 }
    ...
    String getName() {
    	...
    	else if(definitionEnum != null)
    		return definitionEnum.getName();
    	else 
    		return definitionStaticImportedField.getName();
    }
    ...
    OJModifier getModifiers() {
    	if(definitionEnum == null)
    		...
    		return OJModifier.forParseTree( definitionEnum.getModifiers() );
    }

    OJClass getType() {
    	String type_name = "";
    	if(definition != null)
    		type_name = definition.getTypeSpecifier().toString();
    	else if(definitionEnum != null)
    		type_name = definitionEnum.getEnumType();
    	else
    		type_name = definitionStaticImportedField.getReferenceType().toString();
    ...
    final EnumConstant getEnumConstant()
	throws CannotAlterException
    {
