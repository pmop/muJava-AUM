...
public final class OJMethod implements OJMember
{
    ...
    public OJMethod( Environment env, OJClass declarer, MethodCall d ) {
    	this.substance = new OJMethodSourceCode( env, declarer, d );
    }
...
class OJMethodSourceCode extends OJMethodImp
{
    ...
    private MethodDeclaration	definition = null;
    private Environment			env;
    private MethodCall			definitionMethodCall = null;;
	...
	{
		this.declarer = declarer;
		this.definitionMethodCall = ptree;
		this.env = env;
		this.id = idCounter++;
	}
    ...
    String getName() {
    	if(definition != null)
    		...
    		return definitionMethodCall.getName();
    }
    ...
    OJClass getReturnType() {
    	if(definition != null){
    		...
    		String type_name = definitionMethodCall.getReferenceType().toString();
			return Toolbox.forNameAnyway( env, type_name );
    	}
